...
class ForceDisabled extends CustomEmailNotification
{
    ...
    public function toMail(): MailMessage
    {
        ...
        $mail->subject("DeployFlow: Server ({$this->server->name}) disabled because it is not paid!");
