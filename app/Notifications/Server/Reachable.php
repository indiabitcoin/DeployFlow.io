...
class Reachable extends CustomEmailNotification
{
    ...
    public function toMail(): MailMessage
    {
        ...
        $mail->subject("DeployFlow: Server ({$this->server->name}) revived.");
    ...
    {
        return [
            'message' => "DeployFlow: Server '{$this->server->name}' revived. All automations & integrations are turned on again!",
        ];
    }
