...
class StatusChanged extends CustomEmailNotification
{
    ...
    public function toMail(): MailMessage
    {
        ...
        $fqdn = $this->fqdn;
        $mail->subject("DeployFlow: {$this->resource_name} has been stopped");
    ...
    public function toDiscord(): DiscordMessage
    {
        return new DiscordMessage(
            ...
            description: '[Open Application in DeployFlow]('.$this->resource_url.')',
    ...
    {
        $message = 'DeployFlow: '.$this->resource_name.' has been stopped.';
