        ...
        <div class="flex flex-col gap-2 py-4">
            ...
            <div>
                ...
                @if ($application->build_pack === 'dockercompose')
                    ...
                    <div class="w-96">
                        ...
                        {{-- <x-forms.checkbox label="Readonly labels"
                            helper="Labels are readonly by default. Readonly means that edits you do to the labels could be lost and DeployFlow will autogenerate the labels for you. If you want to edit the labels directly, disable this option. <br><br>Be careful, it could break the proxy configuration after you restart the container as DeployFlow will now NOT autogenerate the labels for you (ofc you can always reset the labels to the DeployFlow defaults manually)."
                ...
                @if ($application->build_pack !== 'dockercompose')
                    ...
                    @can('update', $application)
                            <x-modal-confirmation title="Confirm Labels Reset to DeployFlow Defaults?"
                            ...
                            'Proxy labels (traefik, caddy, etc) will be reset to the DeployFlow defaults.',
                        ]" confirmationText="{{ $application->fqdn . '/' }}"
