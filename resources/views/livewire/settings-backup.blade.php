<div>
    ...
    <div class="flex flex-col">
        ...
        <div class="pb-4">Backup configuration for DeployFlow instance.</div>
        <div>
            @if ($server->isFunctional())
                ...
                @else
                    To configure automatic backup for your DeployFlow instance, you first need to add a database resource
                    into DeployFlow.
                    <x-forms.button class="mt-2" wire:click="addDeployFlowDatabase">Configure Backup</x-forms.button>
                @endif
            @else
