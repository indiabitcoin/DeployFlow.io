...
use App\Livewire\DeployFlow\Dashboard as DeployFlowDashboard;
use App\Livewire\DeployFlow\FlowBuilder;
...
Route::middleware(['auth', 'verified'])->group(function () {
    Route::middleware(['throttle:force-password-reset'])->group(function () {
        ...
        // DeployFlow.io Routes
        Route::get('/deployflow', DeployFlowDashboard::class)->name('deployflow.dashboard');
        Route::get('/deployflow/builder', FlowBuilder::class)->name('deployflow.builder');
        Route::get('/deployflow/builder/{flowId}', FlowBuilder::class)->name('deployflow.builder.edit');
        
        // Deployment Routes
        Route::post('/deploy/manual', [DeploymentController::class, 'manualDeploy'])->name('deploy.manual');
        Route::get('/deploy/status', [DeploymentController::class, 'deploymentStatus'])->name('deploy.status');
...
// DeployFlow.io Deployment Webhook
Route::post('/webhooks/deploy', [DeploymentController::class, 'githubWebhook'])->name('webhooks.deploy');
