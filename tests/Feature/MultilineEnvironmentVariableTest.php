...
test('multiline environment variables are properly escaped for docker build args', function () {
    $sshKey = 'PLACEHOLDER_TEST_KEY_FOR_MULTILINE_ENV_TEST';
    ...
    expect($sshArg)->toContain('PLACEHOLDER_TEST_KEY');
...
test('real world SSH key example', function () {
    ...
    expect($arg)->toStartWith('--build-arg KEY="PLACEHOLDER_TEST_KEY_FOR_MULTILINE_ENV_TEST');
    expect($arg)->toEndWith('PLACEHOLDER_TEST_KEY_FOR_MULTILINE_ENV_TEST"');
